  ...
  class ExperimentalWithCallbackMethod_Add : public BaseClass {
   ...
   public:
    ...
    void SetMessageAllocatorFor_Add(
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::calculator::AddRequest, ::calculator::AddResponse>*>(
    ...
    virtual void Add(::grpc::ServerContext* /*context*/, const ::calculator::AddRequest* /*request*/, ::calculator::AddResponse* /*response*/, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
   ...
   public:
    WithStreamedUnaryMethod_Add() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::calculator::AddRequest, ::calculator::AddResponse>(std::bind(&WithStreamedUnaryMethod_Add<BaseClass>::StreamedAdd, this, std::placeholders::_1, std::placeholders::_2)));
    }
